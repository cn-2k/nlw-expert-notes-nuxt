<template>
  <button
    class="relative space-y-3 overflow-hidden rounded-md bg-slate-800 p-5 text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400"
  >
    <span class="text-sm font-medium text-slate-300">há 2 dias</span>
    ...
    <p class="text-sm leading-6 text-slate-400">
      ...
      iusto ducimus sapiente, error placeat ratione vel. Voluptatibus sequi quis
      ratione.
    </p>
